...
const xLbl = makeLabel("X", "#ff4444"); xLbl.position.set(0.8, 0, 0);  axisScene.add(xLbl);
const yLbl = makeLabel("Y", "#44ff44"); yLbl.position.set(0, 0.8, 0);  axisScene.add(yLbl);
const zLbl = makeLabel("Z", "#4444ff"); zLbl.position.set(0, 0, 0.8);  axisScene.add(zLbl);
